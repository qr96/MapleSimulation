...
public class UsedPopup extends Activity {
    ...
    public void updateUsed(){
        ...
        if(equipment.used_myungjangcube > 0)
            usedList = usedList + "명장의 큐브 : " + equipment.used_myungjangcube + "\n";
        if(equipment.used_jangincube > 0)
            usedList = usedList + "장인의 큐브 : " + equipment.used_jangincube + "\n";
